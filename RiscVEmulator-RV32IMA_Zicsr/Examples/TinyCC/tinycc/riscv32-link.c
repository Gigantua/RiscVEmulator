...
/* Match emulator memory map: code starts at 0x1000 */
...
ST_FUNC unsigned create_plt_entry(TCCState *s1, unsigned got_offset, struct sym_attr *attr)
{
    ...
    write32le(p, got_offset); /* 32-bit GOT offset for RV32 */
    return plt_offset;
}
...
ST_FUNC void relocate_plt(TCCState *s1)
{
    ...
    if (p < p_end) {
        ...
        write32le(p + 16, 0x00038293             /* addi t0, t2, %pcrel_lo(got) */
                          | (((got - plt) & 0xfff) << 20));
        write32le(p + 20, 0x00235313);           /* srli t1, t1, log2(16/PTRSIZE=4) = 2 */
        write32le(p + 24, 0x0042a283);           /* lw t0, 4(t0)  [PTRSIZE=4] */
        ...
        while (p < p_end) {
            ...
            write32le(p + 4, 0x0002be03          /* lw t3, %pcrel_lo(func@got)(t3) */
                             | (((addr - pc) & 0xfff) << 20));
              ...
              addr_t addr, addr_t val)
{
    ...
    case R_RISCV_32:
        ...
        return;
    case R_RISCV_64:
        /* R_RISCV_64 should not appear in RV32 code; treat as R_RISCV_32 */
        add32le(ptr, val);
        return;
    case R_RISCV_JUMP_SLOT:
        add32le(ptr, val);
