...
// --toolchain=clang uses the project's self-built ~/llvm-rv32i/ (see
// Core/WslClang.cs); the shim falls back to apt clang-18 if that tree
// isn't built yet, hence the safety-net packages.
