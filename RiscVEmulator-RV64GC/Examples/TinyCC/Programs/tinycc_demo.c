/*
 * tinycc_demo.c — TinyCC JIT example for the RV64GC emulator.
 *
 * Embeds TinyCC (libtcc.c, ONE_SOURCE) compiled for RV64 (TCC_TARGET_RISCV64).
...
void _start(void)
{
    ...
    printf("=== TinyCC JIT demo on RV64GC ===\n\n");
    ...
    printf("\nMandelbrot set (60x22, rendered by JIT'd RV64 code):\n");
    mandelbrot(60, 22);
