...
/* pragma */
    ...
    !defined(TCC_TARGET_ARM) && !defined(TCC_TARGET_ARM64)
     /* already defined for assembler — except in this RISCV64 build, which
      * ships no riscv64-asm.c / riscv64-tok.h, so #pragma pack(push/pop)
      * needs these tokens defined here (as the RISCV32 build already does). */
